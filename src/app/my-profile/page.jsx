...
export default function MyProfile() {
    ...
    return (
        <div className="min-h-screen bg-slate-50/50 dark:bg-slate-950 py-24 px-4 transition-colors duration-300">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-sm border border-gray-100 dark:border-slate-800 overflow-hidden mb-8">
                    ...
                    <div className="px-8 pb-8 -mt-16 text-center md:text-left md:flex md:items-end md:gap-6">
                        <div className="relative inline-block">
                            <img
                                className="w-32 h-32 rounded-3xl ring-8 ring-white dark:ring-slate-900 object-cover shadow-xl bg-white dark:bg-slate-800"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white dark:bg-slate-900 p-6 rounded-[2rem] border border-gray-100 dark:border-slate-800 shadow-sm">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between text-sm">
                                    ...
                                    <span className="font-bold text-gray-700 dark:text-gray-200">2026</span>
                                </div>
                                <div className="flex items-center justify-between text-sm">
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-white dark:bg-slate-900 p-8 md:p-10 rounded-[2.5rem] border border-gray-100 dark:border-slate-800 shadow-sm">
                            ...
                            <form onSubmit={handleUpdate} className="space-y-6">
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-12 pr-5 py-4 bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 text-gray-900 dark:text-white rounded-2xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all outline-none font-medium"
                                            required
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-bold text-gray-700 dark:text-gray-300 ml-1">Profile Photo URL</label>
                                    <div className="relative">
                                        <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400">
                                            <ImageIcon size={20} />
                                        </div>
                                ...
                                <div className="space-y-2 opacity-60">
                                    <label className="text-sm font-bold text-gray-700 dark:text-gray-300 ml-1">Email Address (Fixed)</label>
                                    <div className="relative">
                                        <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400">
                                            <Mail size={20} />
                                        </div>
                                        <input
                                            ...
                                            value={user?.email}
                                            disabled
                                            className="w-full pl-12 pr-5 py-4 bg-gray-100 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 text-gray-500 dark:text-gray-400 rounded-2xl cursor-not-allowed font-medium"
                                        />
                                    </div>
                                </div>
